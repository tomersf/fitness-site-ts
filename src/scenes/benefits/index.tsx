...
import BenefitsGraphicPage from "@/assets/BenefitsPageGraphic.png";
      ...
      >
        ...
        <div className="mt-16 items-center justify-between gap-20 md:mt-28 md:flex">
          ...
          <div>
            ...
            >
              <p className="my-5">
                Helping you achieve your fitness goals through a combination of
                expert advice, personalized training plans, and a supportive
                community.
              </p>
              <p className="mb-5">
                Whether you're looking to lose weight, build muscle, or simply
                improve your overall health and well-being, we have the tools
